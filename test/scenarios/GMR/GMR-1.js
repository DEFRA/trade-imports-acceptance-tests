  ...
  it('', async function () {
    ...
    await newClearanceRequest()
      ...
      .then(async (test) => {
        ...
        testLogger.info('Waiting for GMR on Clearance Decision')
        await test.waitForGmrCustomDeclaration(this.gmrRef, this.mrnRef)
        testLogger.info('Received GMR on Clearance Decision')
      })
  })
})
