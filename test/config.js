...
export const TRADE_IMPORTS_DECISION_COMPARER_USER = process.env.TRADE_IMPORTS_DECISION_COMPARER_USER;
export const TRADE_IMPORTS_DECISION_COMPARER_KEY = process.env.TRADE_IMPORTS_DECISION_COMPARER_KEY;
